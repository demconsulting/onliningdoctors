...
// Lazy-load every admin section. Each panel is heavy (forms, charts, dnd-kit, etc.)
// and only one is shown at a time, so eager-loading all 23 of them adds hundreds
// of KB to the admin entry bundle for no benefit.
